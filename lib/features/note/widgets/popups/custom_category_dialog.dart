...
class CustomCategoryDialogState extends State<CustomCategoryDialog> {
  ...
  void _onCategorySelected(String category, Color? color) {
    ...
    Navigator.pop(context, {'text': category, 'color': color, 'isCategoryColor': false});
  }
    ...
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Colors.black.withAlpha(40), blurRadius: 15, offset: const Offset(0, 6)),
          ],
        ),
        child: Padding(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Text(text, style: TextStyle(fontSize: AppSizes.fontSizeMd, color: isSelected ? containerColor : context.isDarkMode ? AppColors.white : AppColors.black)),
              ],
            ),
          ),
        ),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.book_outlined, size: 26, color: context.isDarkMode ? AppColors.white : AppColors.black),
