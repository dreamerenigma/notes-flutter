...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Text _title(BuildContext context, String text) {
    return Text(text, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: context.isDarkMode ? AppColors.white : AppColors.black));
  }

  Text _body(BuildContext context, String text) {
    return Text(text, style: TextStyle(fontSize: AppSizes.fontSizeSm, height: 1.4, color: context.isDarkMode ? AppColors.white : AppColors.black));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'Политика конфиденциальности'),
      body: ScrollbarTheme(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _body(
                    context,
                    'This Privacy Policy provides our policies and procedures for collecting, using, and disclosing your information. Users access the ColorNote service (“Service”) through the application, through APIs, and through third-parties. A “Device” is any computer used to access the ColorNote Service, including without limitation a desktop, laptop, mobile phone, tablet, or other consumer electronic device. This Privacy Policy governs your access of the ColorNote Service, regardless of how you access it, and by using our Service you consent to the collection, transfer, processing, storage, disclosure and other uses described in this Privacy Policy. All of the different forms of data, content, and information described below are collectively referred to as “information.”',
                  ),
                  const SizedBox(height: 35),
                  _title(context, '1. The Information We Collect And Store'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                    'We may collect and store the following information when running the ColorNote Service:\n\n'
                    'Information You Provide. When you register for an account, we collect some Personal Information, such as your name and email address. You may also ask us to import your contacts by giving us access to your third party services (for example, your email account) or to use your social networking information if you give us access to your account on social network connection services. You may also provide us with your contacts’ email addresses when sharing folders or files with them. We may also receive Personal Information (for example, your email address) through other users, for example if they have tried to share something with you.\n\n'
                    'Your Data. We collect and store data you upload, download, or access with the Service (“Data”).\n\n'
                    'Log Data. When you use the Service, we automatically record information from your Device, its software, and your activity using the Service. This may include the Device’s Internet Protocol (“IP”) address, information you search for through the Service, locale preferences, identification numbers associated with your Devices, your mobile carrier, date and time stamps, system configuration information, and other interactions with the Service.\n\n'
                    'Cookies. We also use “cookies” to collect information and improve our Service. A cookie is a small data file that we transfer to your Device. We may use “persistent cookies” to save your registration ID and login password for future logins to the Service. We may use “session ID cookies” to enable certain features of the Service, to better understand how you interact with the Service and to monitor aggregate usage and web traffic routing on the Service. You can instruct your browser, by changing its options, to stop accepting cookies or to prompt you before accepting a cookie from the websites you visit. If you do not accept cookies, however, you may not be able to use all aspects of the Service.',
                  ),
                  const SizedBox(height: 35),
                  _title(context, '2. How We Use Personal Information And Why'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                    'Personal Information. In the course of using the Service, we may collect personal information that can be used to contact or identify you (“Personal Information”). Personal Information is or may be used: (i) to provide and improve our Service, (ii) to administer your use of the Service, (iii) to better understand your needs and interests, (iv) to personalize and improve your experience, and (v) to provide or offer software updates and product announcements. If we communicate with you, and you no longer wish to receive communications from us, please follow the “unsubscribe” instructions provided in any of those communications, or update your settings information.\n\n'
                    'Geo-Location Information.  Some Devices allow applications to access real-time location-based information (for example, GPS). Our mobile application does not collect such information from your mobile device at any time while you download or use our mobile apps as of the date this policy went into effect, but may do so in the future with your consent to improve our Service.\n\n'
                    ...
                    'Your Data. You have control over who sees the Data you uploaded, downloaded or access with the Service. We cannot view it unless you expressly give us permission or it’s necessary to comply with our legal obligations. Specifically: To help refine or improve the technology, we may ask you for permission to review portions of your Data. Also if you contact our Customer Support team for help with specific pieces of Data in your account (for example, if you can’t find a note you believe should be in your account), we may ask for your temporary permission to look at your Data. This permission terminates when the issue is resolve.\n\n'
                  ...
                  const SizedBox(height: 35),
                  _title(context, '3. Information Sharing and Disclosure'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                    'Use. We do not sell your personal information to third parties. We may share or disclose your information with your consent, for example if you use a third party application to access your account (see below). Through certain features of the Service, you may also have the ability to make some of your information public.\n\n'
                    'Service Providers, Business Partners and Others. We use certain trusted third party companies and individuals to help us provide, analyze, and improve the Service (including but not limited to data storage, maintenance services, database management, analytics, and improvement of the Service’s features). These third parties may have access to your information only for purposes of performing these tasks on our behalf and under obligations similar to those in this Privacy Policy. You can view the third parties we use to help us provide our Service in Appendix 1.\n\n'
                    'Third-Party Applications. We may share your information with a third party application with your consent, for example when you choose to access our Service through such an application. We are not responsible for what those parties do with your information, so you should make sure you trust the application and that it has a privacy policy acceptable to you.\n\n'
                    'Compliance with Laws and Law Enforcement Requests; Protection of ColorNote’s Rights.   We may disclose to parties outside ColorNote Data and information about you that we collect when we have a good faith belief that disclosure is reasonably necessary to (a) comply with a law, regulation or compulsory legal request; (b) protect the safety of any person from death or serious bodily injury; (c) prevent fraud or abuse of ColorNote or its users; or (d) to protect ColorNote’s property rights.\n\n'
                  ...
                  const SizedBox(height: 35),
                  _title(context, '4. Your Rights Relating To Your Information'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                    'You can contact us at support@socialnmobile.com to ask us to provide access to, correct, update, or delete your personal information. We may ask you for proof of account ownership and/or identity before fulfilling your request. This is a security measure to ensure that your information is not disclosed to any person who has no right to receive it.  In some cases we may retain copies of your information if required by law. Please note that some or all of your personal information may be required in order for us to provide you with access to the certain specific functionalities of our Service.\n\n'
                    ...
                    'Request the transfer of your personal information. We will provide to you your personal information in a structured, commonly used, machine-readable format. Note that this right only applies to automated information which you initially provided consent for us to use or where we used the information to perform a contract with you.\n\n'
                  ...
                  const SizedBox(height: 35),
                  _title(context, '5. How Long We Store Your Information'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                  ...
                  const SizedBox(height: 35),
                  _title(context, '6. Where We Store Your Information'),
                  const SizedBox(height: 10),
                  _richBody(context),
                  const SizedBox(height: 35),
                  _title(context, '7. Security'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                  ...
                  const SizedBox(height: 35),
                  _title(context, '8. Our Policy Toward Children'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                    'Our Service is not directed to persons under 13. We do not knowingly collect personally identifiable information from children under 13. If a parent or guardian becomes aware that his or her child has provided us with Personal Information without their consent, he or she should contact us at support@socialnmobile.com.  If we become aware that a child under 13 has provided us with Personal Information, we will take steps to delete such information from our files.'
                  ),
                  const SizedBox(height: 35),
                  _title(context, '9. Changes to our Privacy Policy'),
                  const SizedBox(height: 10),
                  _body(
                    context,
                  ...
                  const SizedBox(height: 35),
                  _title(context, '10. Contact Us'),
                  const SizedBox(height: 10),
                  RichText(
                    text: TextSpan(
                      style: TextStyle(fontSize: AppSizes.fontSizeMd, height: 1.4, color: context.isDarkMode ? AppColors.white : AppColors.black),
                      children: [
                        const TextSpan(text: 'Social & Mobile, Inc. welcomes your comments regarding this Privacy Policy. Please contact us by email at '),
                        TextSpan(
                          text: 'support@socialnmobile.com',
                          style: TextStyle(color: AppColors.blueAccent, fontSize: AppSizes.fontSizeMd, decoration: TextDecoration.none),
                          recognizer: TapGestureRecognizer()..onTap = () async {
                            final uri = Uri(scheme: 'mailto', path: 'support@socialnmobile.com');
                            await launchUrl(uri);
                          },
                        ),
                      ],
  ...
  Widget _richBody(BuildContext context) {
    ...
    return Text.rich(
      TextSpan(
        ...
        children: [
          const TextSpan(
            text:
            'If you register for an account and sync your device with our Service, your Information (including but not limited your Data), will be stored on servers hosted by Google Cloud Platform or Amazon Web Service. '
            'For information regarding Google Cloud Platform Data Processing and Security Terms, please visit ',
          ),
          TextSpan(
            text: 'https://cloud.google.com',
            style: const TextStyle(color: AppColors.blueAccent, decoration: TextDecoration.none),
            recognizer: TapGestureRecognizer()..onTap = () async {
              await launchUrl(Uri.parse('https://cloud.google.com'));
            },
          ),
          const TextSpan(text: '. For information regarding Amazon Web Service, please visit '),
          TextSpan(
            text: 'https://aws.amazon.com/',
            style: const TextStyle(color: AppColors.blueAccent, decoration: TextDecoration.none),
            recognizer: TapGestureRecognizer()..onTap = () async {
              await launchUrl(Uri.parse('https://aws.amazon.com/'));
            },
          ),
