...
class AppColors {
  ...
  static const Color blue = Color(0xFF0842A0);
  static const Color blueAccent = Color(0xFF2D75D7);
  ...
  static const Color textPurple = Color(0xFF988FAD);
  ...
  static Color darkContainer = Colors.white.withAlpha((0.1 * 255).toInt());
  ...
  // Other colors
  static const Color greySlate = Color(0xFF202224);
  static const Color greyDarker = Color(0xFF191919);
  static const Color greyBlue = Color(0xFF0B141A);
  static const Color cardColor = Color(0xFF111111);
  static const Color blackGrey = Color(0xFF131314);
  static const Color popupColorDark = Color(0xFF202528);
  static const Color greyDarkerV1 = Color(0xFF252525);
  static const Color darkSlate = Color(0xFF303030);
  ...
  static const Color pink = Color(0xFFFFDFEF);

  // Circle button
  static const Color lightBlue = Color(0xFF72B9E3);
  static const Color darkBlue = Color(0xFF004A77);
  static const Color lightGreen = Color(0xFF6CA681);
  static const Color darkGreen = Color(0xFF0F5223);
